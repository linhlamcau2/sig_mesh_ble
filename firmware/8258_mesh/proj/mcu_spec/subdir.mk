...
proj/mcu_spec/%.o: ../proj/mcu_spec/%.S
	...
	tc32-elf-gcc -Xassembler"C:\Users\NV-Smart03\Downloads\dualmode\sig_mesh_sdk\firmware" -DMCU_STARTUP_8258_RET_16K -D__PROJECT_MESH__=1 -DCHIP_TYPE=CHIP_TYPE_8258 -c -o"$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
